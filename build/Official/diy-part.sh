...
export OpenClash_branch="master"         # OpenClash代码选择分支（master 或 dev）
export Required_Topic="argon"            # 将bootstrap替换您需要的其他主题为必选主题,名称必须写对,源码内必须有该主题(填0为关闭)
...
export Remove_Firewall="1"               # 删除默认防火墙(1为开,0为关闭)
